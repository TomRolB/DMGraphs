...
public interface Graph<T> {
    ...
    void addVertex(T x);
    /**
     *removeVertex: this method should delete a vertex that should already exist in the structure. If not, this method should do nothing.
     * @param x : T type object that should represent a vertex from the graph. SHOULD NOT BE NULL.
     */
     ...
     * @param v : vertex from the graph. SHOULD NOT BE NULL
     * @param w : vertex from the graph. SHOULD NOT BE NULL
     * @param weight: edge weight. SHOULD NOT BE LESS THAN OR EQUAL TO ZERO
     */
